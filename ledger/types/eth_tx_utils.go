// Copyright 2020 The go-ethereum Authors, Adapted to Script
...
// TranslateEthTx an ETH transaction to a Script smart contract transaction
func TranslateEthTx(ethTxStr string) (*SmartContractTx, error) {
	...
	from := TxInput{
		Address:   fromAddr,
		Coins:     coins,
		Sequence:  ethTx.nonce() + 1, // off-by-one, ETH tx nonce starts from 0, while Script tx sequence starts from 1
		Signature: sig,
	}
